...
var Gantt = (function () {
  ...
  class Bar {
    ...
    update_handle_position() {
      const bar = this.$bar;
      const elLeft = this.handle_group.querySelector('.handle.left');
      const elRight = this.handle_group.querySelector('.handle.right');
      elLeft && elLeft.setAttribute('x', bar.getX() + 1);
      elRight && elRight.setAttribute('x', bar.getEndX() - 9);
